...
# from sklearn.metrics.pairwise import cosine_similarity
# import numpy as np
# # from backend_voices_data.backend_data_uploader import get_gcp_credentials
...
# # LOG_FILENAME_PREFIX = os.getenv("FEEDS_LOG_FILE")
...
#     log_filepath = os.path.join(LOG_DIR, 'feeds.log')
